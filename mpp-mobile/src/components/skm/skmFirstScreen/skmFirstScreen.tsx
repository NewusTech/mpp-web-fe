...
export default function SKMFirstScreen() {
  const dispatch = useDispatch();
  const { survei, setSurvei } = useGlobalContext();
  ...
  console.log(instances, "DInas");
  console.log(instanceId, "id dinas");
  console.log(service, "layanan");
  ...
  console.log(survei, "ini survey");

  return (
    <div className="flex items-center justify-center mt-[24px] mb-[200px]">
