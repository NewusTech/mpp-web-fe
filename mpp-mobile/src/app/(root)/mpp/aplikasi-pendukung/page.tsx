...
export default function AplikasiPendukung() {
  ...
  return (
    <div className="flex flex-col justify-between pt-8 md:px-28 md:gap-y-8">
      <div className="flex flex-col md:flex-row md:grid md:grid-cols-3 flex-wrap gap-x-3 gap-y-4">
        {supportApps &&
